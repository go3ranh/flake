{ self, config, lib, pkgs, ... }: {
  ...
  services = {
    ...
    keycloak = {
      enable = true;
      sslCertificateKey = "/var/run/acme/id.goeranh.de/key.pem";
      sslCertificate = "/var/run/acme/id.goeranh.de/cert.pem";
      settings = {
      hostname = "localhost";
    ...
    database = {
      type = "postgresql";
      createLocally = true;
      passwordFile = "/var/lib/keycloak/pw";
    };
  };
};
networking = {
